...
df = pd.read_csv(r"C:\Users\cristhian.choque\Desktop\Cursos\Diplomado PUCP\Modulo I\Python para Ciencia de Datos\Trabajo de Curso\TB_CENTRO_VACUNACION.csv",
                 sep = ";")

df_1 = pd.read_csv(r"C:\Users\cristhian.choque\Desktop\Cursos\Diplomado PUCP\Modulo I\Python para Ciencia de Datos\Trabajo de Curso\TB_UBIGEOS.csv",
                 sep = ";")
